...
// Diff compares the state read from a db connection or migration directory with
...
// NamedDiff compares the state read from a db connection or migration directory with
...
// between the Ent schema and the connected db.
